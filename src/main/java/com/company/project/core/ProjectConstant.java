package main.java.com.company.project.core;
...
public final class ProjectConstant {
    ...
    public static final String BASE_PACKAGE = "main.java.com.company.project";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
